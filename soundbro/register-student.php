...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // --- VALIDATION ---
    // presence check
    if (!$firstName or !$lastName or !$email or !$parentEmail or !$password or !$confirmPassword) {
        ...
        if ($validLength_fname and $characterSetValid_fname and $noNumbers_fname) {
            ...
            if ($validLength_lname and $characterSetValid_lname and $noNumbers_lname){
                ...
                if (!$email or !$parentEmail) {
                    $error="Invalid email / parent email";
                } else {
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-md-8 bg-white p-5 rounded-4 shadow">
            <h2 class="text-center mb-4 text-primary">Register a Student</h2>
